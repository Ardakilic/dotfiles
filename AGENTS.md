...
- **Third-party skills:** The `matt-review` skill under `config/opencode/skills/` is sourced from [mattpocock/skills](https://github.com/mattpocock/skills) (MIT). It is vendored as-is with only the frontmatter `name` changed. Update by re-fetching from upstream.
